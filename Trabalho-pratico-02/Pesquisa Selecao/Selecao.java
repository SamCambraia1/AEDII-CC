...
public class Selecao {
    ...
    public static boolean pesqSequencial(String entrada) {
        ...
        for (int i = 0; i < coutPlayers; i++) {
            if (ply[i].getNome().equals(entrada) == true) {
                resp = true;
                i = coutPlayers;
        ...
        return resp;
    }// end Pesquisa Sequenciaç

    public static void Imprimir() {
        System.out.println("[" + ply[coutPlayers].getId() + " ## " + ply[coutPlayers].getNome() + " ## "
                + ply[coutPlayers].getAltura() + " ## " + ply[coutPlayers].getPeso() + " ## "
                + ply[coutPlayers].getAnoNascimento() + " ## " + ply[coutPlayers].getUniversidade() + " ## "
                + ply[coutPlayers].getCidadeNascimento() + " ## " + ply[coutPlayers].getEstadoDeNascimento() + "]");
