...
class Player{
    ...
    private int  id;           private String universidade;
    private int altura;        private String nome;
    private int peso;          private String cidadeNascimento; 
    private int anoNascimento; private String estadoNacimento;
...
public class classe{ 
    ...
    public static void Imprimir(){
       System.out.println("["+ply[coutPlayers].getId()+" ## "+ply[coutPlayers].getNome()+" ## "+ply[coutPlayers].getAltura()+" ## "+ply[coutPlayers].getPeso()
        +" ## "+ ply[coutPlayers].getAnoNascimento()+" ## "+ ply[coutPlayers].getUniversidade()+" ## "+ply[coutPlayers].getCidadeNascimento()+
        " ## " +ply[coutPlayers].getEstadoDeNascimento()+"]");
